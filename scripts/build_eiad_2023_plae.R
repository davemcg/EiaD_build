...
# CPM scale
scalePB <- metamoRph::normalize_data(as.matrix(pbH),  log1p = FALSE)
...
system("mkdir ~/git/eyeIntegration_app/inst/app/www/2023/")
scEiaD_pool <- dbConnect(RSQLite::SQLite(), dbname = "~/git/eyeIntegration_app/inst/app/www/2023/scEiaD.sqlite")
#Writing the tables
