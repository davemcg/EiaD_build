...
cont.matrix_all <- makeContrasts(RPE_Cell.Line_vs_RPE_Stem.Cell.Line="RPE_Cell.Line-RPE_Stem.Cell.Line",
                                 ...
                                 Retina_Fetal.Tissue_vs_Cornea_Stem.Cell.Line="Retina_Fetal.Tissue-Cornea_Stem.Cell.Line",
                                 Body_vs_Cornea_Stem.Cell.Line="Body-Cornea_Stem.Cell.Line",
                                 Retina_Fetal.Tissue_vs_Lens_Stem.Cell.Line="Retina_Fetal.Tissue-Lens_Stem.Cell.Line",
