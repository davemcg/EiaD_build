...
srr <- read_csv('data/SRP156453.sra.txt')


SRP156453_list <- list()
for (i in srr %>% filter(source_name == "Retinal pigment epithelum obtained from eye tissue") %>% pull(Run) ){
  print(i)
  ...
  SRP156453_list[[i]] <- out %>% data.frame()
  Sys.sleep(1) 
}

SRP156453_meta <- SRP156453_list %>% bind_rows() %>% 
