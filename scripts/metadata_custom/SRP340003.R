...
srr <- read_csv('data/SRP340003.sra.txt')


SRP340003_list <- list()
for (i in srr %>% filter(Treatment == 'CI-HS') %>% pull(Run) ){
  print(i)
  ...
  SRP340003_list[[i]] <- out %>% data.frame()
  Sys.sleep(1) 
}

SRP340003_meta <- SRP340003_list %>% bind_rows() %>% 
