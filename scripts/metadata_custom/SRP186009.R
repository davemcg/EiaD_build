...
srr <- read_csv('data/SRP186009.sra.txt')


SRP186009_list <- list()
for (i in srr %>% filter(Tissue == 'Retinal pigment epithelial cells') %>% pull(Run) ){
  print(i)
  ...
  SRP186009_list[[i]] <- out %>% data.frame()
  Sys.sleep(1) 
}

SRP186009_meta <- SRP186009_list %>% bind_rows() %>% 
