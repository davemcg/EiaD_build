...
srr <- read_csv('data/SRP356976.sra.txt')


SRP356976_list <- list()
for (i in srr %>% filter(grepl("CON_", `Sample Name`), Tissue == 'corneal epithelium') %>% pull(Run) ){
  print(i)
...
SRP356976_meta <- SRP356976_meta[,colnames(SRP356976_meta)[!grepl('\\.', colnames(SRP356976_meta))]]
