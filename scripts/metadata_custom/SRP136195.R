...
srr <- read_csv('data/SRP136195.sra.txt')


SRP136195_list <- list()
for (i in srr %>% filter(grepl("Control", Individual)) %>% pull(Run) ){
  print(i)
  ...
  SRP136195_list[[i]] <- out %>% data.frame()
  Sys.sleep(1) 
}

SRP136195_meta <- SRP136195_list %>% bind_rows() %>% 
...
SRP136195_meta <- SRP136195_meta[,colnames(SRP136195_meta)[!grepl('\\.', colnames(SRP136195_meta))]]
