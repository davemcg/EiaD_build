...
srr <- read_csv('data/SRP107937.sra.txt')


SRP107937_list <- list()
for (i in srr %>% filter(eye_histological_phenotype == 'Normal') %>% pull(Run) ){
  print(i)
  ...
  SRP107937_list[[i]] <- out %>% data.frame()
  Sys.sleep(1) 
}

SRP107937_meta <- SRP107937_list %>% bind_rows() %>% 
